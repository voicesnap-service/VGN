...
class InAppUpdate(activity: Activity,UpdateAvailable:String,ForceUpdate:String) : InstallStateUpdatedListener {
    ...
    private fun flexibleUpdateDownloadCompleted() {
        ...
        Snackbar.make(parentActivity.findViewById(R.id.SplashLayout),
